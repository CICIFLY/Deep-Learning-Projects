...
vis_image_index = 0
l1 =  "/home/hscilab282-10/Desktop/Xi_Zhou/AI/11_6_2018_CNN/CNN_Face/l1"
l2 = "/home/hscilab282-10/Desktop/Xi_Zhou/AI/11_6_2018_CNN/CNN_Face/l2"

# load in the data 
dataset = np.loadtxt('Xi_face_gen.txt', delimiter=' ')
...
model.add(Dense(2,activation='softmax',name='l4'))   # number of output nodes 64 to 32 to 10    (10,1) is the output
